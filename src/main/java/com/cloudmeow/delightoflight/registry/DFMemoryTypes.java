...
public class DFMemoryTypes {
    ...
    public static final Supplier<MemoryModuleType<Integer>> GROW_HORN_TICKS = MEMORIES.register("grow_horn_ticks",
            ()-> new MemoryModuleType<>(Optional.empty()));
    public static final Supplier<MemoryModuleType<Integer>> SHAKE_HEAD_TICKS = MEMORIES.register("shake_head_ticks",
            ()-> new MemoryModuleType<>(Optional.empty()));
    public static final Supplier<MemoryModuleType<List<Goat>>> NEAREST_GOAT = MEMORIES.register("nearest_goat",
            ()-> new MemoryModuleType<>(Optional.empty()));
}