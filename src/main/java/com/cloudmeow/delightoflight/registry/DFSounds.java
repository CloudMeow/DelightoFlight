...
public class DFSounds {
    ...
    public static final Supplier<SoundEvent> MOON_SLASH = SOUNDS.register("entity.moon_slash.slash",
            () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(DelightoFlight.MOD_ID, "entity.moon_slash.slash")));
    ...
    public static final Supplier<SoundEvent> COTTON_CANDY_MACHINE_PLACE = SOUNDS.register("block.cotton_candy_machine.place",
            () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(DelightoFlight.MOD_ID, "block.cotton_candy_machine.place")));
    public static final Supplier<SoundEvent> COTTON_CANDY_MACHINE_REMOVE = SOUNDS.register("block.cotton_candy_machine.remove",
            () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(DelightoFlight.MOD_ID, "block.cotton_candy_machine.remove")));

    public static final Supplier<SoundEvent> MOONLIGHT_TRANSFORMATION = SOUNDS.register("misc.moonlight_transformation.craft",
            () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(DelightoFlight.MOD_ID, "misc.moonlight_transformation.craft")));
}
