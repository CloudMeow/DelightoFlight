...
public class DFItems {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(Registries.ITEM, DelightoFlight.MOD_ID);
    ...
    public static Item.Properties cottonCandyItem(FoodProperties food) {
        return new Item.Properties().food(food).craftRemainder(Items.STICK).stacksTo(64);
    }

    public static final Supplier<Item> CLOUD_SILK = ITEMS.register("cloud_silk",
            ()-> new Item(new Item.Properties()));
    public static final Supplier<Item> PHANTOM_WING = ITEMS.register("phantom_wing",
            ()-> new Item(new Item.Properties()));
    public static final Supplier<Item> THUNDER_FRUIT = ITEMS.register("thunder_fruit",
    ...
    public static final Supplier<Item> CHORUS_FRUIT_COTTON_CANDY = ITEMS.register("chorus_fruit_cotton_candy",
            ()-> new ConsumableChorusFruit(cottonCandyItem(DFFoodValue.CHORUS_FRUIT_COTTON_CANDY)));
    public static final Supplier<Item> CLOUD_BERRY_COTTON_CANDY = ITEMS.register("cloud_berry_cotton_candy",
            ()-> new ConsumableItem(cottonCandyItem(DFFoodValue.CLOUD_BERRY_COTTON_CANDY), true));
    public static final Supplier<Item> ENCHANTED_GOLDEN_APPLE_COTTON_CANDY = ITEMS.register("enchanted_golden_apple_cotton_candy",
            ()-> new ConsumableItem(cottonCandyItem(DFFoodValue.ENCHANTED_GOLDEN_APPLE_COTTON_CANDY).rarity(Rarity.EPIC).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true), true));
    public static final Supplier<Item> GLOW_BERRY_COTTON_CANDY = ITEMS.register("glow_berry_cotton_candy",
            ()-> new ConsumableItem(cottonCandyItem(DFFoodValue.GLOW_BERRY_COTTON_CANDY), true));
    public static final Supplier<Item> GOLDEN_APPLE_COTTON_CANDY = ITEMS.register("golden_apple_cotton_candy",
            ()-> new ConsumableItem(cottonCandyItem(DFFoodValue.GOLDEN_APPLE_COTTON_CANDY), true));
    public static final Supplier<Item> MELON_COTTON_CANDY = ITEMS.register("melon_cotton_candy",
            ()-> new ConsumableItem(cottonCandyItem(DFFoodValue.MELON_COTTON_CANDY), true));
    public static final Supplier<Item> SWEET_BERRY_COTTON_CANDY = ITEMS.register("sweet_berry_cotton_candy",
            ()-> new ConsumableItem(cottonCandyItem(DFFoodValue.SWEET_BERRY_COTTON_CANDY), true));
    public static final Supplier<Item> THUNDER_FRUIT_COTTON_CANDY = ITEMS.register("thunder_fruit_cotton_candy",
            ()-> new ConsumableItem(cottonCandyItem(DFFoodValue.THUNDER_FRUIT_COTTON_CANDY), true));
    ...
    public static final Supplier<Item> HAM_SALAD = ITEMS.register("ham_salad",
    ...
    public static final Supplier<Item> CLOUD_SILK_BED = ITEMS.register("cloud_silk_bed",
            ()-> new BlockItem(DFBlocks.CLOUD_SILK_BED.get(), new Item.Properties().stacksTo(1)));
    public static final Supplier<Item> CLOUD_BERRY_PANCAKE_TOWER = ITEMS.register("cloud_berry_pancake_tower",
    ...
    public static final Supplier<Item> COTTON_CANDY_MACHINE = ITEMS.register("cotton_candy_machine",
            ()-> new BlockItem(DFBlocks.COTTON_CANDY_MACHINE.get(), new Item.Properties()));
    public static final Supplier<Item> CLOUD_BERRY_BAG = ITEMS.register("cloud_berry_bag",
