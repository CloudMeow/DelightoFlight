...
public class CookBookScreen extends AbstractContainerScreen<CookBookMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        guiGraphics.blit(ResourceLocation.fromNamespaceAndPath(DelightoFlight.MOD_ID, "textures/gui/cook_book.png"), this.leftPos, this.topPos, 0,0, this.imageWidth, this.imageHeight);
    }
}
