...
public class SpinningRecipeCategory implements IRecipeCategory<CottonCandyMachineRecipe> {
    ...
    public SpinningRecipeCategory(IGuiHelper helper) {
        ...
        ResourceLocation bgLoc = new ResourceLocation (DelightoFlight.MOD_ID, "textures/gui/jei/cotton_candy_machine.png");
    ...
    @Override
    public RecipeType<CottonCandyMachineRecipe> getRecipeType() {
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, CottonCandyMachineRecipe recipe, IFocusGroup focuses) {
    ...
    @Override
    public void draw(CottonCandyMachineRecipe recipe, IRecipeSlotsView slotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
    ...
    @Override
    public void getTooltip(ITooltipBuilder tooltip, CottonCandyMachineRecipe recipe, IRecipeSlotsView slotsView, double mouseX, double mouseY) {
        if (ClientRenderUtils.isCursorInsideBounds(43, 1, 22, 20, mouseX, mouseY)) {
            int spinTime = recipe.getSpinTime();
            if (spinTime > 0) {
