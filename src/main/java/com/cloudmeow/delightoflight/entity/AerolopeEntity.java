...
public class AerolopeEntity extends Animal {
    ...
    protected static final ImmutableList<MemoryModuleType<?>> MEMORY_TYPES = ImmutableList.of(
            ...
            DFMemoryTypes.NEAREST_GOAT.get(),
    ...
    @Override
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor accessor, DifficultyInstance difficultyInstance, MobSpawnType type, @Nullable SpawnGroupData data, @Nullable CompoundTag tag) {
        RandomSource randomsource = accessor.getRandom();
        AerolopeAi.initMemories(this, randomsource);
        this.entityData.set(DELAY, -1);
        this.ageBoundaryReached();
        return super.finalizeSpawn(accessor, difficultyInstance, type, data, tag);
    }
    ...
    public void addAdditionalSaveData(CompoundTag tag) {
        ...
        if (tag.contains("Mushroom")) {
            this.mushroom = ItemStack.of(tag.getCompound("Mushroom"));
        }
    ...
    public void readAdditionalSaveData(CompoundTag tag) {
        ...
        if (!getMushroom().isEmpty()) {
            tag.put("Mushroom", getMushroom().save(new CompoundTag()));
        }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DELAY, -1);
